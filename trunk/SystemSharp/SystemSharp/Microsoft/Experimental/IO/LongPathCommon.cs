...
namespace Microsoft.Experimental.IO {
    ...
    internal static class LongPathCommon {
        ...
        internal static string RemoveLongPathPrefix(string normalizedPath) {
            Contract.Requires<ArgumentNullException>(normalizedPath != null);
            Contract.Requires<ArgumentException>(normalizedPath.Length >= NativeMethods.LongPathPrefix.Length);
