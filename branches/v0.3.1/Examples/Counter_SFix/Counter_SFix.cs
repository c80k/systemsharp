...
namespace SystemSharp.Examples.CounterSFix
{
    class Bundle
    {
        /// <summary>
        ...
        class Counter : Component
        {
            ...
            public Out<SFix> Ctr { private get; set; }

            /// <summary>
            /// An internal signal to store the current counter value.
            /// </summary>
            private Signal<SFix> _ctr = new Signal<SFix>()
            {
                InitialValue = SFix.FromDouble(0, 7, 1)
            };
        ...
        class SimpleCounterTestbench : Component
        {
            ...
            /// </summary>
            private Signal<SFix> _count = new Signal<SFix>()
            {
                InitialValue = SFix.FromDouble(0, 7, 1)
            };
            ...
            private ConsoleLogger<SFix> _m_logger;
            ...
            public SimpleCounterTestbench()
            {
                ...
                _m_logger = new ConsoleLogger<SFix>()
                {
                    DataIn = _count
                };
            }
