/**
 * This code is a nice workaround for Windows' incapability of handling path names >260 charcters.
 * It uses the UNICODE API which as able to treat up to 32k charcters.
